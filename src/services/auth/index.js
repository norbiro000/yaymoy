...
export default {
  authenticate: function (provider) {
    ...
    if (provider !== undefined) {
      ...
      window.location.href = 'https://' + domain + '/oauth2/authorize?identity_provider=' + provider + '&response_type=' + type + '&client_id=' + clientId + '&redirect_uri=' + callback + '&state=' + verification + '&scope=' + scope
    } else {
      // Use the hosted UI
